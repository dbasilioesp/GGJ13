...
local rato = {}
rato.new = function( direcao, cor)

        local options =  { width=200, height=100, numFrames=2, sheetContentWidth=400, sheetContentHeight=100 };
        local RatoVermelhoVertical = graphics.newImageSheet("ratos/RatoVermelhoVertical.png", options);
        local RatoVermelhoHorizontal = graphics.newImageSheet("ratos/RatoVermelhoHorizontal.png", options);
        local RatoVermelhoHorizontalEsquerda = graphics.newImageSheet("ratos/RatoVermelhoHorizontalEsquerda.png", options);       
        local RatoVerdeVertical = graphics.newImageSheet("ratos/RatoVerdeVertical.png", options);
        local RatoVerdeHorizontal = graphics.newImageSheet("ratos/RatoVerdeHorizontal.png", options);
        local RatoVerdeHorizontalEsquerda = graphics.newImageSheet("ratos/RatoVerdeHorizontalEsquerda.png", options);
        local RatoAmareloVertical = graphics.newImageSheet("ratos/RatoAmareloVertical.png", options);
        local RatoAmareloHorizontal = graphics.newImageSheet("ratos/RatoAmareloHorizontal.png", options);
        local RatoAmareloHorizontalEsquerda = graphics.newImageSheet("ratos/RatoAmareloHorizontalEsquerda.png", options);
        local RatoAzulVertical = graphics.newImageSheet("ratos/RatoAzulVertical.png", options);
        local RatoAzulHorizontal = graphics.newImageSheet("ratos/RatoAzulHorizontal.png", options);
        local RatoAzulHorizontalEsquerda = graphics.newImageSheet("ratos/RatoAzulHorizontalEsquerda.png", options);
